    ...
    <AnimatePresence mode="wait">
      ...
      >
        <Link
          href={"/"}
          className={cn(
            "relative items-center flex space-x-1 text-neutral-300 dark:hover:text-neutral-200 hover:text-neutral-500",
          )}
        >
          <span className="block text-2xl sm:hidden">+</span>
          <span className="hidden text-sm sm:block">Create</span>
        </Link>
        ))
        <button className="relative py-2 px-4 text-sm font-medium rounded-full border dark:text-white text-neutral-300 border-white/[0.2]">
          <span>HOME</span>
